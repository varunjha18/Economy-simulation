...
function changeoutput(outputyear,newvalue,g2){
    document.getElementById('C').innerHTML = `Consumption <br> in year ${outputyear} is <br><br> <b style="color:Blue;font-size:32px;line-height:0px">${newvalue.C}</b>`;
    document.getElementById('G').innerHTML = `Government expenditure<br> in year ${outputyear} is <br> <b style="color:Blue;font-size:32px;line-height:40px;">${newvalue.G}</b>`;
    document.getElementById('I').innerHTML = `Investment <br> in year ${outputyear} is <br><br> <b style="color:Blue;font-size:32px;line-height:10px">${newvalue.I}</b>`;
    document.getElementById('Y').innerHTML = `National GDP<br> in year ${outputyear} is <br><br> <b style="color:Blue;font-size:32px;line-height:10px">${newvalue.Y}</b>`;
    document.getElementById('F_def').innerHTML = `Fiscal deficit<br> in year ${outputyear} is <br><br> <b style="color:Blue;font-size:32px;line-height:10px">${newvalue.F_def}</b>`;
    document.getElementById('MPC').innerHTML = `Marginal Propensity to consume is <br><b style="color:Blue;font-size:32px;line-height:40px;">${newvalue.MPC}</b>`;
    document.getElementById('gold').innerHTML =  `Growth rate<br> in year ${outputyear-1} is <br><br> <b style="color:Blue;font-size:32px;line-height:10px">${g2} %</b>`;
    document.getElementById('g').innerHTML = `Growth rate<br> in year ${outputyear} is <br><br> <b style="color:Blue;font-size:32px;line-height:10px">${newvalue.g} %</b>`;
    document.getElementById('t').innerHTML = `Tax Rate <br> in year ${outputyear} is <br><br> <b style="color:Blue;font-size:32px;line-height:10px">${newvalue.t} %</b>`;
